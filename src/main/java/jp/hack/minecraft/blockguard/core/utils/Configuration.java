...
import static jp.hack.minecraft.blockguard.core.utils.I18n.tl;
...
public class Configuration extends YamlConfiguration {
    ...
    private Future<?> delayedSave(final File file) {
        ...
        return EXECUTOR_SERVICE.submit(new Configuration.WriteRunner(configFile, data, pendingDiskWrites));
    }
